<template>
  <footer >
    <div  class="footer-menus" id="contact-us">
      <div  class="contact-us">
        <p  class="menu-title">联系我们</p>
        <p >地址：中国XX省XX市XX区XX路XX商务中心10号楼-04A</p>
        <p >电话：+86 13512341234</p>
        <p >传真：+86 13512341234</p>
        <p >邮箱：13512341234@163.com</p>
      </div>
      ...
      <div  class="qrcode">
        <p  class="menu-title">公司二维码</p><img  src="/assets/images/qrcode.png"
          alt="">
      </div>
      <div  class="icps">
        <p  class="icp-info"><a  href="https://beian.miit.gov.cn"
            target="_blank">粤ICP备 20240103XX号-1</a></p>
        <p  class="icp-info-plz"><img 
            ...
            alt=""><a  href="https://beian.mps.gov.cn/#/query/webSearch?code=4405070XXXXXXX"
            target="_blank">粤公网安备 4405070XXXXXXX</a></p>
      </div>
